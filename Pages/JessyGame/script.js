...
const gameOver = document.querySelector('.game-over')
    ...
    let elementoContador = document.querySelector('.score')
    ...
    const loop = setInterval(() => {
        ...
        if(pipePosition <= 60 && pipePosition > 0 && marioPosition < 40){//primeiro controlar o left do pipe, segundo ver se o mario cairia em cima do pipe, terceiro controlar se o pula do mario foi alto o suficiente
            gameOver.play()
            audio.pause()
            ...
            reiniciar.style.background = "pink"
            ...
            elementoContador.style.borderRadius= '10px'
            elementoContador.style.border= 'none'
